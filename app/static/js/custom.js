function showStep(stepId) {
  ...
  function fetchAndNotify() {
    ...
    fetch(notifi)
        ...
        //             <div class="progress-bar progress-bar-striped" role="progressbar" style="width: ${progressPercentage}; background-color: #ccc; height: 20px;" aria-valuenow="${progressPercentage}" aria-valuemin="0" aria-valuemax="100">
        //             </div>
        //         </div>
        ...
        <div class="progress-wrapper">
            <div class="progress" style="width: 100px; border: 1px solid #ccc;">
                <div class="progress-bar" role="progressbar" style="width: ${progressPercentage}%; background-color: #ccc; height: 20px;" aria-valuenow="${progressPercentage}" aria-valuemin="0" aria-valuemax="100">
